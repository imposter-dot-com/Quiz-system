...
class Question{
    ...
    public:
    Question() : question_id(0), correct_answer(0), difficulty(BEGINNER) {}

    Question(int question_id, const string& question_text, const vector<string>& options, const vector<string>& category, int correct_answer, Difficulty difficulty);
    ...
    void SaveToFile(ofstream& file) const{
        file << "ID,Question,Category,Difficulty,CorrectAnswer,Options\n";
